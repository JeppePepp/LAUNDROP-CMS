...
<script>
    ...
    export default {
        ...
        data(){
            return {
                descriptionList : ['Wash your hands frequently ', 
                                    'Maintain social distancing', 
                                    'Avoid touching eyes, nose and mouth',
                                    'Practice respiratory hygiene',
                                    'Stay home if you are sick.'],
                image: {backgroundImage: "url(https://upload.wikimedia.org/wikipedia/commons/9/96/3D_medical_animation_coronavirus_structure.jpg)"}
            }
        }
    }
</script>
